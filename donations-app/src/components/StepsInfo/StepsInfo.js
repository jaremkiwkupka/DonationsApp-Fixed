...
export const StepsInfo = ({isMobile}) => {
    return (
        <section className="steps-info container">
            ...
            <div className={isMobile ? "mobile-steps-info-box" : "steps-info-box"}>
                <div className={isMobile ? "mobile-steps-info-box--item" : "steps-info-box--item"}>

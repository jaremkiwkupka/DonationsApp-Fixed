...
export const LocalCollectionItem = ({ localCollections, toggleState, total, perPage, paginate }) => {
    ...
    return (
        <div className={toggleState === 3 ? "who-we-help-tContainer active-content" : "who-we-help-tContainer"}>
            {localCollections.map(localCollection => (
                <div className={isMobile ? "mobile-who-we-have-table" : "who-we-have-table"} key={localCollection.id}>
                    <div>
